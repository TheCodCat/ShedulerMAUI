...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ShedulerMAUI.dll" comes first in this list. */
		"ShedulerMAUI.dll",
		"ClientSamgk.Models.Api.Mfc.dll",
		"ClientSamgk.Models.Api.dll",
		"ClientSamgk.Models.Enums.dll",
		"ClientSamgk.Models.Params.dll",
		"ClientSamgk.dll",
